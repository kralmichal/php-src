...
/* {{{ Str::contains(string $string, string $needle): bool */
PHP_METHOD(Str, contains)
{
	zend_string *str, *needle;
	...
	RETURN_BOOL(php_memnstr(ZSTR_VAL(str), ZSTR_VAL(needle), ZSTR_LEN(needle),
		ZSTR_VAL(str) + ZSTR_LEN(str)));
}
/* }}} */

/* {{{ Str::startsWith(string $string, string $prefix): bool */
PHP_METHOD(Str, startsWith)
{
	zend_string *str, *prefix;
	...
	RETURN_BOOL(zend_string_starts_with(str, prefix));
}
/* }}} */

/* {{{ Str::endsWith(string $string, string $suffix): bool */
PHP_METHOD(Str, endsWith)
{
	zend_string *str, *suffix;
	...
	if (ZSTR_LEN(suffix) > ZSTR_LEN(str)) {
		RETURN_FALSE;
	}
	RETURN_BOOL(memcmp(ZSTR_VAL(str) + ZSTR_LEN(str) - ZSTR_LEN(suffix),
