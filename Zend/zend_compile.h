 ...
 * as Str/Int: "float" is not a reserved class name, so a userland `class Float {}` is legal and
 * stays legal — the leading NUL keeps the backing class from colliding with it, and
